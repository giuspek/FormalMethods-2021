...
; I've written the equivalent representation considering the possible choices instead of aborting unvalid choices, so you can compare the two and understand their equivalence in the case in question as I briefly mentioned in classroom.
